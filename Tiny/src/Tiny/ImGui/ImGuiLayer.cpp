...
namespace Tiny
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use Tiny key codes
	...
	void ImGuiLayer::OnUpdate()
	{
		...
		io.DisplaySize = ImVec2(app.GetWinow().GetWidth(), app.GetWinow().GetHeight());
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(TY_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	}
